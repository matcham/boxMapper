...
, 			{
				"box" : 				{
					"annotation" : "none",
					"args" : [ "openHelp", "openEditor", "viewInteractionBox" ],
					"bgmode" : 0,
					"border" : 1,
					"clickthrough" : 0,
					"enablehscroll" : 0,
		...
		"parameters" : 		{
			...
			"obj-4::obj-4::obj-11::obj-4::obj-71" : [ "tab[4]", "tab[1]", 0 ],
			...
			"obj-4::obj-4::obj-11::obj-4::obj-158" : [ "textbutton[5]", "textbutton", 0 ],
...
, 			{
				"name" : "boxMapper_synthFM.model.maxpat",
				"bootpath" : "~/Dropbox/boxMapper/boxMapper/patchers/modules/synthFM",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
